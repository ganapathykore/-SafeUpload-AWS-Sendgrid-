        ...
        if(len(invoice_not_found_array)==0):
            html_content = f"""
                    <body>
                        <h3>{body}</h3>
                        <p>{phrase_one}</p>
                        <h4><p>For future inquiries, please utilize <a href="https://my.cassport.com" target="_blank">CassPort</a> as your initial source of invoice status and payment information.</p></h4>
